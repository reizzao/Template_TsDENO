import { RepositoriesOptions } from "@global_types";
import { IExample1Repository, JsonExample1Repository, MemoryExample1Repository, CreateExample1UseCase } from "@example1";
